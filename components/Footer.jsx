...
const FooterLinks = ({ items, heading }) => (
  <div className="flex-1 justify-start items-start">
    <h3 className="font-sans-serif dark:text-white text-nft-black-1 font-semibold text-xl mb-6">{heading}</h3>
    ...
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:p7-8 py-16 ">
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16 justify-around items-center">
        ...
        <div className="flex flexBetweenStart flex-wrap md:ml-0 md:place-self-center ">
          ...
          <p className="dark:text-white text-nft-black-1 font-extrabold text-3xl ml-2 font-sans-serif">BlockBeatz</p>
        </div>
        {/* CONTACT FORM */}
        <div className="flex flex-col justify-center items-center">
          <p className="font-sans-serif dark:text-white text-nft-black-1 font-semibold mt-6">Get the latest updates</p>
          <div className="flexBetween md:w-full minlg:w-557 w-357 mt-6 dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 rounded-md">
            <input type="email" placeholder="karthikgoud3720@gmail.com" className="h-full flex-1 w-full dark:bg-nft-black-2 bg-white px-4 rounded-md dark:text-white text-nft-black-1 font-normal text-xs minlg:text-lg outline-none" />
      ...
      <div className="flexCenter w-full mt-5 border-t dark:border-nft-black-1 border-nft-gray-1 sm:px-4 px-16">
        <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          <p className="flex font-sans-serif dark:text-white text-nft-black-1 font-medium">BlockBeatz, All rights reserved</p>
