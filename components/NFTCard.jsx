  ...
  return (
    ...
    >
      <div className="flex flex-col min-w-215 xs:max-w-none sm:w-full sm:min-w-155 minmd:w-256 minlg:min-w-327 dark:bg-nft-black-3 bg-white rounded-2xl p-4 m-4 minlg:m-8 sm:my-2 sm:mx-2 cursor-pointer shadow-md">
        ...
        <div className="mt-3 flex flex-col gap-5 relative w-full">
        ...
        <div className="relative w-full h-[4rem] rounded-2xl overflow-hidden ">
          {nft.audio && (
              <audio className="absolute  bottom-0 left-0 w-full" src={nft.audio} controls />
          )}
        </div>
      </div>
        <div className="mt-3 flex flex-col">
          <p className=" font-sans-serif font-bold text-md minlg:text-lg">{nft.name}</p>
